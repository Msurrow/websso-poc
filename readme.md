...
####CORS
Client-side app = JS i browseren. Men JS anvendes ikke til selve IdP integrationen, så CORS bør ikke være et problem.
...
## 10 second guide til installation af Python og dependencies
